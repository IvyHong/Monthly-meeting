...
Single event effect have an impact on electronic devices, especially applied in outer space, aircraft altitude and high altitude areas. On the sea level, neutron as one of the factors induced single event effect has received attentions since (zigler). 

 
\subsection{Position the collimator and detectors}
According to papar, it shows a user standard position of detectors and collimator.


\section{Progress against the plan}

Qt debugger cannot use which means.
